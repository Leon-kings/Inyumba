...
// // ============================================================
// // MAIN COMPONENT - HouseOnRent (UPDATED with API data)
// // ============================================================
...
//   // ============================================================
//   // SUBMIT BOOKING - Matches Mongoose Schema
//   // ============================================================
...
//         formData.append(
//           "monthlyRent",
//           String(selectedHouse?.pricePerMonth || 0),
//         );
...
//           formData.append(
//             "paymentScreenshot",
//             bookingData.step3.screenshotFile,
//           );
//         }
...
//   const openBookingModal = (house: ApiHouse) => {
//     setSelectedHouse(house);
//     setCurrentStep(1);
...
//   const openViewModal = (house: ApiHouse) => {
//     setSelectedHouse(house);
...
//         <div className="text-center">
//           <div className="w-12 h-12 sm:w-16 sm:h-16 border-4 border-[#FF385C] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
...
//       {/* Success Modal - NO landlord contact details */}
//       <AnimatePresence>
...
//                     </p>
//                     <p className="text-lg font-mono font-bold text-[#FF385C]">
//                       {bookingReference}
//                     </p>
//                   </div>
...
//                       {t.bookingDetailsSummary || "Booking Summary"}
//                     </h4>
//                     <div className="space-y-1 text-sm">
//                       <p>
//                         <span className="text-gray-500">
//                           {t.houseName || "House Name"}:
//                         </span>{" "}
...
//                         }
//                       }}
//                       className="flex-1 bg-[#FF385C] text-white py-3 rounded-lg font-medium hover:bg-[#E31C5F] transition-colors text-sm"
//                     >
//                       {t.viewBookingDetails || "View Booking Details"}
//                     </button>
//                     <button
//                       onClick={() => setIsSuccessModalOpen(false)}
//                       className="px-4 py-3 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors text-sm"
//                     >
//                       {t.closeModal || "Close"}
//                     </button>
//                   </div>
...
//                   <h3 className="text-xl font-bold text-gray-900 mb-2">
//                     {t.bookingFailedTitle || "Booking Failed ❌"}
//                   </h3>
...
//                             <span>
//                               {house.rating || 0} ({house.totalReviews || 0})
//                             </span>
//                           </div>
//                         </div>
...
//       {/* View Details Modal - Updated with NO landlord contact details */}
//       <AnimatePresence>
...
//                     {selectedHouse.images.map((img, index: number) => (
//                       <img
//                         key={index}
...
//                             );
//                           else if (amenity === "Kitchen" || amenity === "water")
//                             icon = (
...
//                             );
//                           else if (amenity === "Security" || amenity === "AC")
//                             icon = (
...
//                       {/* Summary - Only shows Service Fee */}
//                       <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
//                         <p className="text-xs sm:text-sm text-gray-600">
//                           <span className="font-medium">
...
//                   {/* Step 3: Payment - Only Service Fee */}
//                   {currentStep === 3 && (
//                     <div className="space-y-3 sm:space-y-4">
//                       <div>
...
// HouseOnRent.tsx - Complete file with its own design but same functionality as Hero.tsx
// @ts-nocheck
...
export const HouseOnRent: React.FC<HouseOnRentProps> = ({ onSearch }) => {
  ...
  // ============================================================
  // FETCH HOUSES FROM API - KEEP HOST DATA
  // ============================================================
    ...
    const fetchHouses = async () => {
      try {
        ...
        if (response.data.success) {
          ...
          if (language !== "en") {
            console.log(
              `Translating ${housesData.length} houses to ${language}...`,
            );
            ...
            for (const house of housesData) {
              try {
                const translatedHouse = {
                  ...
                  // ✅ KEEP HOST DATA - Don't overwrite with empty values
                  host: house.host || {
                    name: "",
                    email: "",
                    phone: "",
            ...
            // ✅ KEEP HOST DATA for English too
  ...
  // ============================================================
  // Handle Submit Booking - FIXED with Owner Info & Auto Status Update
  // ============================================================
  const handleSubmitBooking = async () => {
    ...
    try {
      ...
      // ✅ FIX: Send Owner/Host Information
      ...
      console.log("📤 Submitting booking with owner info:", {
        ownerName: hostName,
        ownerContact: hostPhone,
      ...
      if (response.data.success) {
        // ✅ AUTO UPDATE HOUSE STATUS TO "booked"
        try {
          const updateResponse = await API.put(
            `/houses/${selectedHouse?._id}/status`,
            {
              status: "booked",
            },
          );
          if (updateResponse.data.success) {
            console.log("✅ House status updated to 'booked'");
            // Update local state
            setHouses((prevHouses) =>
              prevHouses.map((h) =>
                h._id === selectedHouse?._id ? { ...h, status: "booked" } : h,
              ),
            );
          ...
          console.error("❌ Failed to update house status:", updateError);
  ...
  // ============================================================
  // RENDER - HouseOnRent Design (Different from Hero)
  // ============================================================
  ...
  return (
    <>
      ...
      <div className="w-full mb-4 rounded-2xl">
        {/* ===== HouseOnRent HEADER - Different from Hero ===== */}
        {/* <div className="bg-gradient-to-r from-[#FF385C]/90 to-[#E31C5F]/90 py-10 md:py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">
              🏠 {t.popularHomes || "Student Houses Available"}
            </h1>
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto">
              {language === "rw"
                ? "Shakisha amazu y'abanyeshuri hafi ya Kaminuza yawe"
                : language === "fr"
                  ? "Trouvez des maisons étudiantes près de votre université"
                  : "Find student houses near your university"}
            </p>
          </div>
        </div> */}
        ...
        {/* ===== SEARCH BAR - Same functionality ===== */}
        <div className="relative z-20 -mt-4 px-2 sm:px-4">
          <div className="max-w-5xl mx-auto">
            <motion.div
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ delay: 0.3 }}
              className="bg-white rounded-2xl shadow-xl p-3 sm:p-4 md:p-5 border border-gray-200"
            >
              <div className="flex flex-wrap gap-2">
                <div className="flex-1 min-w-[120px]">
                  <button
        ...
        {/* ============================================================
          PROPERTY DETAIL MODAL - Same functionality
          ============================================================ */}
        <AnimatePresence>
        ...
        {/* ============================================================
          BOOKING MODAL - Same as Hero.tsx
          ============================================================ */}
        <AnimatePresence>
          {isBookingModalOpen && selectedHouse && (
            <>
