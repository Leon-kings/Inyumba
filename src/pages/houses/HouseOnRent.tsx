...
// ============================================================
// MAIN COMPONENT - HouseOnRent (UPDATED with Hero's payment logic)
// ============================================================
...
export const HouseOnRent: React.FC = () => {
  ...
  // ============================================================
  // UPDATED: Handle Submit Booking - Matches Mongoose Schema (same as Hero)
  // ============================================================
  const handleSubmitBooking = async () => {
    if (currentStep === 3) {
      const allTouched: Record<string, boolean> = {
  ...
  return (
    <>
      ...
      {/* Success Modal - NO landlord contact details (same as Hero) */}
      <AnimatePresence>
        {isSuccessModalOpen && selectedHouse && (
          <>
            <motion.div
            ...
            >
              <div className="w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto rounded-xl sm:rounded-2xl shadow-2xl bg-white relative">
                ...
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                  ...
                  {/* Contact Details - ONLY shown after payment (same as Hero) */}
                  {paymentCompleted && selectedHouse.host && (
                    <div className="border-t border-gray-200 pt-3 sm:pt-4">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="font-semibold text-gray-900 text-sm sm:text-base">
      ...
      {/* Booking Modal - Updated with Hero's payment logic */}
      <AnimatePresence>
        {isBookingModalOpen && selectedHouse && (
          <>
            <motion.div
            ...
            >
              <div className="w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto rounded-xl sm:rounded-2xl shadow-2xl bg-white relative">
                ...
                <div className="p-4 sm:p-6 space-y-4">
                  ...
                  {/* Step 2: Booking Details - Uses Months instead of Nights (same as Hero) */}
                  {currentStep === 2 && (
                    <div className="space-y-3 sm:space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <div>
