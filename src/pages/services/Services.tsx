...
const translations = {
  en: {
    ...
    description:
      "INYUMBA offers a wide range of services designed to make finding and managing student housing simple, safe, and stress-free.",
  ...
  fr: {
    ...
    description:
      "INYUMBA offre une large gamme de services conçus pour rendre la recherche et la gestion de logements étudiants simple, sûre et sans stress.",
  ...
  rw: {
    ...
    tagline: "Amazu y'Abanyeshuri",
    description:
      "INYUMBA itanga serivisi nyinshi zateguwe kugira ngo gushaka no kugenzura amazu y'abanyeshuri bibe byoroshye, bifite umutekano, kandi nta mpungenge.",
    ourServices: "Serivise Dutanga",
    forStudents: "Ku banyeshuri",
    forLandlords: "Kubatunze Inzu / Ba nyir'inzu",
    forUniversities: "Kuri za kaminuza",
    studentServices: "Serivisi Ku banyeshuri",
    landlordServices: "Serivisi Kuri Ba nyir'inzu",
    universityServices: "Serivisi Kuri za kaminuza",
    ...
    step2Desc:
      "Hitamo inzu ukunda maze wiyandikishe ako kanya. Aba bishinzwe baremeza ubwishyu ubone ubutumwa bwo kwemeza na numero ya nyir'inzu kuri Dashboard.",
    step3: "Tanga Imbaraga MOMO",
    step3Desc:
      "Kora ubwishyu bufite umutekano ukoresheje MOMO. Ubwishyu bwawe burabungabungwa kugeza ugeze mu nzu.",
    step4: "Kwinjira & Kwigira",
    step4Desc:
      "Injira mu nzu yawe nta mpungenge. Itsinda ryacu ribishinzwe rishobora kugufasha.",
    whyChoose: "Kuki Wahitamo Serivisi Zacu",
    stats: "Imibare Y'umushinga",
    statsHeading: "Impinduka Zacu Mu Mibare",
    activeUsers: "Abakoresha",
    successfulBookings: "Ubusabe Bwakunze",
    verifiedHouses: "Amazu Yemejwe",
    activeLandlords: "Abatunze Inzu / Landloards",
    satisfaction: "Kunyurwa",
    contact: "Twandikire",
    contactDesc:
      "Ufite ikibazo kuri serivisi zacu? Twandikire kandi twiteguye kugufasha.",
    name: "Izina Ryawe",
    ...
    service1Desc:
      "Amazu yose kuri urubuga rwacu abanza kwemezwa n' ikipe ibishinzwe kugira ngo habeho ubwiza n'umutekano.",
    service2: "Ibiciro Byiza ku banyeshuri",
    service2Desc: "Ibiciro bihendutse biteganyirijwe abanyeshuri.",
    service3: "Kwiyandikisha Bifite Umutekano",
    service3Desc:
      "Kwiyandikisha ako kanya no kwishyura service bifite umutekano binyuze muri MOMO.",
    service4: "Serivisi 24/7",
    service4Desc: "Itsinda ryacu ryateguwe rihora ryiteguye kugufasha.",
    service5: "Kureba Aho Uri",
    service5Desc:
      "Shakisha amazu hafi ya kaminuza yawe ukoresheje tekinoroji nshya.",
    service6: "Gucunga Inzu",
    service6Desc:
      "Gucunga inzu byoroshye kuri banyir'inzu hamwe n'ubutumwa bwo kwiyandikisha.",
    service7: "Ubufatanye N'amakaminuza",
    service7Desc:
      "Ubufatanye bwemewe n'amakaminuza gutanga amazu yemewe kubanyeshuri.",
    service8: "Kureba Ibikoresho",
    service8Desc:
      "Hitamo amazu ukurikije ibikoresho nka WiFi, (parking),umuriro, amazi, umutekano, n'ibindi.",
    service9: "Ubwishyu Bwa MOMO",
    service9Desc: "Ubwishyu bworoshye kandi bufite umutekano ukoresheje MOMO.",
    service10: "Ibikoresho Byo Gucunga",
    service10Desc:
      "Kuri banyir'inzu kugira ngo bacunge, barebe icyemezo, kandi bavugane n'abanyeshuri.",
    service11: "Gusuzuma Inzu",
    service11Desc: "Uburyo bwo gusuzuma inzu na banyir'inzu kubanyeshuri.",
    service12: "Kugenzura Inzu",
    service12Desc: "Kugenzura inzu kugira ngo habeho ubwiza n'umutekano.",
    viewAll: "Reba Zose",
    readMore: "Soma Byinshi",
    bookNow: "Icyemezo",
    becomeHost: "Iyandikishe nka nyir'inzu",
