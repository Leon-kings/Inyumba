...
// API Base URL
const API_URL = "https://inyumbaproject.eu1.hubfly.app/contact";
...
export const MessageManagement: React.FC = () => {
  ...
  const handleToggleStar = async (messageId: string) => {
    ...
    // UI-only feature since the API doesn't support star
    const updatedMessages = messages.map((m) =>
  ...
  const handleToggleFlag = async (messageId: string) => {
    ...
    // UI-only feature since the API doesn't support flag
    const updatedMessages = messages.map((m) =>
