...
//       case "success":
//         return (
//           <CheckCircleOutlineOutlined className="w-16 h-16 text-green-500" />
//         );
//       case "error":
//         return <WarningAmberIcon className="w-16 h-16 text-red-500" />;
//       case "info":
//         return <MarkunreadIcon className="w-16 h-16 text-blue-500" />;
//     }
//   };
...
//     setIsFetching(true);
//     try {
//       // Fetch all bookings and filter by owner email and completed status
...
//           "info",
//           t.noBookingsFound,
//           "No clients have booked your properties yet",
//         );
//       }
//     } catch (error) {
//       console.error("Error fetching bookings:", error);
//       showStatusModal("error", t.fetchError, "Failed to load clients");
//     } finally {
//       setIsFetching(false);
//     }
//   };
...
//     try {
//       // Get messages by email - this is the guest's email
...
//         showStatusModal("info", t.noMessagesFound, "No messages found for this client");
//       }
//     } catch (error) {
//       console.error("Error fetching chat messages:", error);
//       // If no messages exist, that's fine
//       setChatMessages([]);
//     } finally {
...
//         setNewMessage("");
//         showStatusModal("success", t.success, t.messageSent);
//       } else {
//         throw new Error("Failed to send message");
//       }
//     } catch (error) {
//       console.error("Error sending message:", error);
//       showStatusModal("error", t.error, t.messageFailed);
//     } finally {
...
//       showStatusModal("error", t.error, t.replyFailed);
//     } finally {
//       setIsSendingMessage(false);
//     }
//   };
...
//           )
//         );
//         showStatusModal("success", t.success, t.messageRead);
//       } else {
//         throw new Error("Failed to mark as read");
//       }
//     } catch (error) {
//       console.error("Error marking message as read:", error);
//       showStatusModal("error", t.error, t.messageReadFailed);
//     }
//   };
