...
export const UserRequestManagement: React.FC = () => {
  ...
  const openDeleteModal = (request: RequestUI) => {
    setSelectedRequest(request);
    showConfirmModal(
      "⚠️ " + t.deleteRequest || "Delete Request",
      `${t.deleteConfirmation || "Are you sure you want to delete this request?"} ${t.actionUndone || "This action cannot be undone."}`,
      handleDeleteRequest,
      t.delete || "Delete",
      t.cancel || "Cancel",
      "danger",
              ...
              <div className="w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl shadow-2xl bg-white relative">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <span
                        className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(selectedRequest.status)}`}
                      >
