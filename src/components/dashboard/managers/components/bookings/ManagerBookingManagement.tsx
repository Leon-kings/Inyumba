...
export const ManagerBookingManagement: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      {/* Bookings Table - Horizontal Action Buttons with Labels */}
                ...
                filteredBookings.map((booking) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      ...
                      <div className="flex flex-row items-center justify-center gap-0.5 flex-nowrap">
                        <motion.button
                          whileHover={{ scale: 1.1 }}
                          whileTap={{ scale: 0.9 }}
                          onClick={() => openViewModal(booking)}
                          className="p-1.5 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors flex items-center gap-0.5"
                          title={t.viewBooking}
                        >
                        ...
                        <motion.button
                          ...
                          className="p-1.5 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors flex items-center gap-0.5"
                          title={t.editBooking}
                        >
                        ...
                        {booking.status === "pending" && (
                          <motion.button
                            ...
                            className="p-1.5 text-green-600 hover:bg-green-50 rounded-lg transition-colors flex items-center gap-0.5"
                        ...
                        {booking.paymentStatus === "pending" && (
                          <motion.button
                            ...
                            className="p-1.5 text-purple-600 hover:bg-purple-50 rounded-lg transition-colors flex items-center gap-0.5"
                        ...
                        {booking.status === "pending" && (
                          <motion.button
                            ...
                            className="p-1.5 text-orange-600 hover:bg-orange-50 rounded-lg transition-colors flex items-center gap-0.5"
                        ...
                        <motion.button
                          ...
                          className="p-1.5 text-red-600 hover:bg-red-50 rounded-lg transition-colors flex items-center gap-0.5"
