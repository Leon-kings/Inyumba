...
const translations = {
  ...
  fr: {
    ...
    managerViewOnly:
      "Vous avez un accès en visualisation à tous les journaux d'activité",
    ...
    monitorActivities:
      "Surveiller les activités des utilisateurs et les événements système",
  },
  rw: {
    ...
    searchPlaceholder:
      "Shakisha ukurikije umukoresha, igikorwa, IP, ibisobanuro...",
    ...
    monitorActivities:
      "Kurikirana ibikorwa by'abakoresha n'ibyabaye muri sisitemu",
  },
};
...
export const ActivitiesManagement: React.FC = () => {
  ...
  const getActionIcon = (action: string) => {
    const iconMap: { [key: string]: JSX.Element } = {
      ...
      message_created: (
        <MessageIcon className="text-indigo-600" style={{ fontSize: "20px" }} />
      ),
      testimonial_created: (
        <RateReviewIcon
  ...
  const getActionBadgeStyle = (action: string): string => {
    const styleMap: { [key: string]: string } = {
      ...
      testimonial_created: "bg-pink-50 text-pink-700 border-pink-200",
    };
    return styleMap[action] || "bg-gray-50 text-gray-700 border-gray-200";
  };

  // Get action color for dialog
  const getActionColor = (action: string): string => {
    const colorMap: { [key: string]: string } = {
      ...
      message_created: "bg-indigo-100 text-indigo-800 border-indigo-300",
      testimonial_created: "bg-pink-100 text-pink-800 border-pink-300",
    };
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={fetchLogs}
                className="p-2.5 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-100 transition-all duration-200 hover:scale-105 active:scale-95"
                title={t.refresh}
              >
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 group">
            ...
            <div className="mt-2">
              <span className="text-xs text-gray-400">
                Updated from {logs.length} records
              </span>
            </div>
          </div>
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 group">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-800 mt-1 group-hover:text-emerald-600 transition-colors">
                  {stats.uniqueUsers.toLocaleString()}
                </p>
              </div>
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center group-hover:bg-emerald-200 transition-colors">
                <PeopleIcon className="text-emerald-600 w-6 h-6" />
              </div>
            </div>
            <div className="mt-2">
              <span className="text-xs text-gray-400">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 group">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-gray-800 mt-1 capitalize truncate max-w-[180px] group-hover:text-purple-600 transition-colors">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-gray-50 hover:bg-white focus:bg-white"
              />
            ...
            <div className="flex flex-wrap gap-3">
              <select
                ...
                className="px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 hover:bg-white transition-all min-w-[160px] text-sm"
              >
              ...
              <select
                ...
                className="px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 hover:bg-white transition-all min-w-[150px] text-sm"
              >
              ...
              <button
                ...
                className="px-4 py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-all duration-200 flex items-center gap-2 font-medium text-sm active:scale-95"
              >
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center text-blue-700 font-semibold text-sm group-hover:scale-110 transition-transform">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span
                              className={`px-2.5 py-1 rounded-full text-xs font-medium border ${getActionBadgeStyle(log.action)}`}
                            >
                        ...
                        <td className="px-6 py-4 hidden lg:table-cell">
                          <code className="text-xs bg-gray-100 px-2 py-1 rounded-lg font-mono text-gray-700 group-hover:bg-gray-200 transition-colors">
        ...
        >
          ...
          >
            ...
            <div className="p-6 border-b border-gray-200 flex justify-between items-center sticky top-0 bg-white z-10">
              ...
              <div className="flex items-center gap-3">
                <span
                  className={`px-3 py-1.5 rounded-full text-xs font-medium border ${getActionColor(selectedLog.action)}`}
                >
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 space-y-2 border border-gray-200">
                  ...
                  {getUserRole(selectedLog) && (
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-gray-600 capitalize">
                        {t.role}: {getUserRole(selectedLog)}
                      </span>
                    </div>
                  )}
                  {getUserPhone(selectedLog) && (
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-gray-600">
                        {t.phone}: {getUserPhone(selectedLog)}
                      </span>
                    </div>
                  )}
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-gray-400">
                      {t.userID}: {getUserId(selectedLog)}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="p-4 px-6 border-t border-gray-200 flex justify-end sticky bottom-0 bg-white">
              <button
                onClick={() => setDetailDialogOpen(false)}
                className="px-6 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all duration-200 font-medium text-sm hover:shadow-md active:scale-95"
              >
                {t.close}
              </button>
            </div>
