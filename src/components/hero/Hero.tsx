...
//   // ===== Price Categories (moved to right side) =====
...
//                     {language === "rw"
//                       ? "Ibiciro bingana n'ubunini n'ubwiza"
//                       : language === "fr"
//                         ? "Prix selon la taille et la beauté"
//                         : "Price based on size and quality"}
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//                   <p className="text-xs text-gray-500">
//                     {language === "rw"
//                       ? "Kwishyura 10% maze ubone access"
//                       : language === "fr"
//                         ? "Payez 10% et obtenez l'accès"
//                         : "Pay 10% and get access"}
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//                       ? "Huza n'umwene inzu"
//                       : language === "fr"
//                         ? "Connectez-vous avec le propriétaire"
...
//               <span>
//                 {language === "rw"
//                   ? "Kuvana Akarere k'Umudugudu"
//                   : language === "fr"
//                     ? "Du District au Village"
...
//                   ? "Amazu yose yanditse"
//                   : language === "fr"
//                     ? "Toutes les maisons enregistrées"
//                     : "All houses registered"}
//               </span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="w-1.5 h-1.5 bg-[#FF385C] rounded-full"></span>
...
//                   ? "Inyungu ku wenyine"
//                   : language === "fr"
//                     ? "Propriétaire détermine le prix"
//                     : "Owner determines price"}
//               </span>
//             </div>
//           </div>
//         </div>
...
//                                 {t.momoCode || "*182*8*1*6377827#"}
//                               </p>
//                               <a
//                                 href={`tel:${(t.momoCode || "*182*8*1*6377827#").replace(/\*/g, "%2A").replace(/#/g, "%23")}`}
...
// ============================================================
// 1. DATA WITH MULTIPLE IMAGES - EXPANDED UNIVERSITIES
// ============================================================
...
// Expanded student houses data with 50+ universities across Rwanda
const studentHousesData: StudentHouse[] = [
  // ===== UR - CST (Science & Tech) - Kigali =====
  {
    id: 1,
    name: "Gihanga Student Lodge",
    type: "House",
...
const getPriceCategories = (t: any): PriceCategoryOption[] => {
  return [
    ...
    {
      id: "low",
      label: t.categoryLow || "Low (0 - 30,000 RWF)",
      range: "0 - 30,000 RWF",
      icon: <AttachMoneyIcon />,
      color: "from-green-400 to-emerald-500",
      min: 0,
    ...
    {
      id: "medium",
      label: t.categoryMedium || "Medium (30,001 - 90,000 RWF)",
      range: "30,001 - 90,000 RWF",
      icon: <AttachMoneyIcon />,
      color: "from-yellow-400 to-amber-500",
      min: 30001,
      max: 90000,
    ...
    {
      id: "high",
      label: t.categoryHigh || "High (90,001 - 200,000 RWF)",
      range: "90,001 - 200,000 RWF",
      icon: <AttachMoneyIcon />,
      color: "from-red-400 to-rose-500",
      min: 90001,
      max: Infinity,
...
// ============================================================
// 6. LOGIN/REGISTER MODAL (WITH SUCCESS/FAIL AND FULL LABELS)
// ============================================================
...
// ============================================================
// 7. MAIN COMPONENT (Hero) - MODIFIED SEARCH BAR
// ============================================================
...
export const Hero: React.FC<HeroProps> = ({ onSearch }) => {
  ...
  // ===== Filter houses - FIXED: Removed setCurrentPage(1) from here =====
  useEffect(() => {
    let filtered = [...studentHousesData];
    ...
    setFilteredHouses(filtered);
    // REMOVED: setCurrentPage(1) - this was causing the pagination issue
  }, [
    selectedPriceCategory,
    priceCategories,
    searchQuery,
  ...
  // ===== Reset to page 1 ONLY when filters change (separate effect) =====
  useEffect(() => {
    // This effect runs when any filter changes and resets the page to 1
    setCurrentPage(1);
  }, [
    selectedPriceCategory,
    searchQuery,
  ...
  const handleSearch = () => {
    ...
    toast.info(
      `🔍 ${t.search}: ${searchLocation || selectedUniversity || selectedSector || selectedCell || selectedVillage || "All locations in Rwanda"}`,
    );
    setIsLocationModalOpen(false);
    setIsAdvancedSearchOpen(false);
  };
  ...
  return (
    <>
      ...
      <div className="w-full mb-4 rounded-2xl ">
        ...
        {/* ===== SEARCH BAR - MODIFIED: Removed Date and Student, Added Sector, Cell, Village ===== */}
        <div className="relative z-20 -mt-6 px-2 sm:px-4">
          <div className="max-w-4xl mx-auto">
            <motion.div
              initial={{ y: 20, opacity: 0 }}
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  >
                    ...
                    <div className="text-xs sm:text-sm md:text-base text-gray-700 truncate">
                      <LocationCityIcon className="w-3 h-3 sm:w-4 sm:h-4 inline mr-1 text-[#FF385C]" />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  >
                    ...
                    <div className="text-xs sm:text-sm md:text-base text-gray-700 truncate">
                      <ApartmentIcon className="w-3 h-3 sm:w-4 sm:h-4 inline mr-1 text-[#FF385C]" />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  >
                    ...
                    <div className="text-xs sm:text-sm md:text-base text-gray-700 truncate">
                      <DomainIcon className="w-3 h-3 sm:w-4 sm:h-4 inline mr-1 text-[#FF385C]" />
                          ...
                          <div className="mb-2 sm:mb-3 md:mb-4">
                            ...
                            <div className="relative">
                              ...
                              {step1Touched.fullName && (
                                <div className="absolute right-2 sm:right-3 top-1/2 transform -translate-y-1/2">
                                  {step1Errors.fullName ? (
                                    <CancelIcon className="w-3 h-3 sm:w-4 sm:h-4 text-red-500" />
                                  ) : bookingData.step1.fullName.trim() !== "" ? (
                    ...
                    {currentStep === 2 && (
                      <div className="space-y-2 sm:space-y-3 md:space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                          <div className="mb-2 sm:mb-3 md:mb-4">
                            <label className="block text-[10px] sm:text-xs md:text-sm font-medium text-gray-700 mb-0.5 sm:mb-1">
                              {t.checkIn || "Check-in Date"} <span className="text-red-500">*</span>
                            </label>
                            <div className="relative">
                              <input
                                type="date"
                          ...
                          <div className="mb-2 sm:mb-3 md:mb-4">
                            <label className="block text-[10px] sm:text-xs md:text-sm font-medium text-gray-700 mb-0.5 sm:mb-1">
                              {t.checkOut || "Check-out Date"} <span className="text-red-500">*</span>
                            </label>
                            <div className="relative">
                              <input
                                type="date"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                          <div className="mb-2 sm:mb-3 md:mb-4">
                            <label className="block text-[10px] sm:text-xs md:text-sm font-medium text-gray-700 mb-0.5 sm:mb-1">
                              {t.nights} <span className="text-red-500">*</span>
                            </label>
                            <div className="relative">
                              <input
                                type="number"
                    ...
                    {currentStep === 3 && (
                      <div className="space-y-2 sm:space-y-3 md:space-y-4">
                        ...
                        <div className="space-y-2 sm:space-y-3 md:space-y-4">
                          <div className="mb-2 sm:mb-3 md:mb-4">
                            <label className="block text-[10px] sm:text-xs md:text-sm font-medium text-gray-700 mb-0.5 sm:mb-1">
                              {t.momoNumber || "MOMO Number"} <span className="text-red-500">*</span>
                            </label>
                            <div className="relative">
                              <input
                                type="tel"
                          ...
                          <div className="mb-2 sm:mb-3 md:mb-4">
                            ...
                            <div className="flex flex-wrap items-center gap-1 sm:gap-2 md:gap-4">
                              ...
                              {step3Touched.screenshot && (
                                <div>
                                  {step3Errors.screenshot ? (
                                    <CancelIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-red-500" />
                                  ) : bookingData.step3.screenshotPreview ? (
                                    <CheckCircleIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-green-500" />
                                  ) : null}
                                </div>
                              )}
                            </div>
        ...
        {/* ============================================================
            LOCATION MODAL - UPDATED WITH SECTOR, CELL, VILLAGE
            ============================================================ */}
        <AnimatePresence>
          {isLocationModalOpen && (
            <>
                ...
                <div className="bg-white rounded-2xl w-full max-w-md max-h-[80vh] overflow-hidden shadow-2xl">
                  ...
                  <div className="p-3 sm:p-4 overflow-y-auto max-h-[calc(80vh-80px)]">
                    ...
                    <div className="mb-3 sm:mb-4">
                      ...
                      <div className="max-h-24 sm:max-h-32 overflow-y-auto space-y-0.5 sm:space-y-1 border rounded-lg p-1">
                        {uniqueUniversities.slice(0, 10).map((uni) => (
                          <button
                            key={uni}
                            onClick={() => {
                              setSelectedUniversity(uni);
                    ...
                    <div className="mb-3 sm:mb-4">
                      <h4 className="text-xs sm:text-sm font-medium text-gray-500 mb-1.5 sm:mb-2 flex items-center gap-1 sm:gap-2">
                        <LocationCityIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#FF385C]" />
                        {t.sectorLabel || "Sectors"}
                      </h4>
                      <div className="max-h-24 sm:max-h-32 overflow-y-auto space-y-0.5 sm:space-y-1 border rounded-lg p-1">
                        {uniqueSectors.slice(0, 10).map((sector) => (
                          <button
                            key={sector}
                            onClick={() => {
                              setSelectedSector(sector);
                              setSearchLocation(sector);
                              setSelectedUniversity("");
                              setSelectedDistrict("");
                              setSelectedCell("");
                              setSelectedVillage("");
                    ...
                    <div className="mb-3 sm:mb-4">
                      <h4 className="text-xs sm:text-sm font-medium text-gray-500 mb-1.5 sm:mb-2 flex items-center gap-1 sm:gap-2">
                        <ApartmentIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#FF385C]" />
                        {t.cellLabel2 || "Cells"}
                      </h4>
                      <div className="max-h-24 sm:max-h-32 overflow-y-auto space-y-0.5 sm:space-y-1 border rounded-lg p-1">
                        {uniqueCells.slice(0, 10).map((cell) => (
                          <button
                            key={cell}
                            onClick={() => {
                              setSelectedCell(cell);
                              setSearchLocation(cell);
                              setSelectedUniversity("");
                              setSelectedDistrict("");
                              setSelectedSector("");
                              setSelectedVillage("");
                    ...
                    {/* Villages Section - NEW */}
                    <div>
                      <h4 className="text-xs sm:text-sm font-medium text-gray-500 mb-1.5 sm:mb-2 flex items-center gap-1 sm:gap-2">
                        <DomainIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#FF385C]" />
                        {t.villageLabel2 || "Villages"}
                      </h4>
                      <div className="max-h-24 sm:max-h-32 overflow-y-auto space-y-0.5 sm:space-y-1 border rounded-lg p-1">
                        {uniqueVillages.slice(0, 10).map((village) => (
                          <button
                            key={village}
                            onClick={() => {
                              setSelectedVillage(village);
                              setSearchLocation(village);
                              setSelectedUniversity("");
                              setSelectedDistrict("");
                              setSelectedSector("");
                              setSelectedCell("");
