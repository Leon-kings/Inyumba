...
// ============================================================
// HERO.TSX - COMPLETE FILE (PART 1 OF 4)
// Copy this entire file content into Hero.tsx
// ============================================================
...
const getVillagesByKey = (
  district: string,
  sector: string,
  cell: string,
): string[] => {
  const key = `${district}|${sector}|${cell}`;
  return ALL_VILLAGES[key] || [];
};
...
const getTranslations = (lang: string) => {
  const translations: Record<string, any> = {
    ...
    rw: {
      popularHomes: "Amazu y'abanyeshuri aboneka",
      room: "Icyumba",
      apartment: "Aparitoma",
      months: "amezi",
      where: "Aho ariho",
      searchDestinations: "Shakisha kaminuza cyangwa aho iherereye mu Rwanda",
      search: "Shakisha",
      favorites: "Iyakunzwe",
      removeFavorite: "Kuraho iyakunzwe",
      addFavorite: "Ongeraho iyakunzwe",
      searchProperties: "Shakisha amazu...",
      noResults: "Nta mazu yabonetse.",
      price: "Igiciro",
      perMonth: "/ ukwezi",
      amenities: "Ibikoresho/ Ibigize",
      university: "Kaminuza",
      district: "Akarere",
      sector: "Umurenge",
      cell: "Akagari",
      village: "Umudugudu",
      rooms: "Ibyumba",
      bathrooms: "Aho bagora",
      viewDetails: "Reba ibindi",
      owner: "Nyiri nzu",
      contact: "Numero",
      bookingStatus: "Icyiciro cy'ubusabe",
      statusAvailable: "Irahari",
      statusBooked: "Yasabwe",
      statusPending: "Irategereje",
      province: "Intara",
      minutesFromCampus: "Iminota uva kuri kaminuza",
      features: "Ibiranga",
      yearBuilt: "Umwaka yubatswemo",
      priceRWF: "Igiciro mu Rwanda",
      advancedSearch: "Ubushakashatsi buhanitse",
      filters: "Ukuyungurura",
      orderNow: "Saba nonaha",
      login: "Kwinjira",
      signup: "Kwiyandikisha",
      selectLocation: "Hitamo aho ariho",
      guests: "Abanyeshuri",
      apply: "Kora",
      clear: "Kuraho",
      prev: "Ibibanziriza",
      next: "Ibikurikira",
      resetFilters: "Kuraho kuyungurura",
      ...
      serviceFee: "Inyishyu ya Serivisi",
      ...
      momoCode: "*182*8*1*6377827*",
      uploadPaymentProof: "Ongeraho ifoto y'ubwishyu",
      chooseFile: "Hitamo ifoto",
      confirmBooking: "Emeza Ubusabe",
      submitting: "Biroherezwa...",
      bookingSuccess: "Ubusabe bwemejwe neza!",
      bookingFailed: "Kurema ubusabe birananiranye",
      pleaseFillAllFields: "Uzuza amakuru yose asabwa",
      personalInfo: "Amakuru yawe",
      payment: "Ubwishyu",
      fullName: "Izina Ryose",
      idNumber: "Nomero y'Indangamuntu",
      studentId: "ID y'Umunyeshuri",
      purpose: "Impamvu yo kuhaba",
      specialRequests: "Ibisabwa Bidasanzwe",
      paymentMethod: "Uburyo bwo Kwishyura",
      momo: "MOMO",
      momoNumber: "Nomero ya MOMO",
      uploadScreenshot: "Ongeraho Ifoto y'Ubwishyu",
      required: "Irakenewe",
      ...
      propertyType: "Ubwoko bw'amazu",
      location: "i",
      from: "kuva",
      perMonthShort: "/ukwezi",
      loginRequired: "Kwinjira birakenewe",
      loginToOrder: "Nyamuneka winjire mbere yo gutegura ubusabe bw'iyi nzu",
      loginNow: "Kwinjira",
      registerNow: "Iyandikishe",
      or: "cyangwa",
      houseDetails: "Ibisobanuro by'azu",
      priceInRWF: "Igiciro mu Rwanda",
      code: "Kode y'umudugudu",
      priceCategories: "Ibyiciro by'Igiciro",
      ...
      dialNow: "Kanda Nonaha",
      ussdCode: "Kode ya USSD",
      paymentComplete: "Ubwishyu Bwoherejwe",
      ...
      landlordInfo: "Amakuru ya nyir'inzu",
      landlordName: "Izina rya nyir'inzu",
      landlordPhone: "Numero ya nyir'inzu",
      landlordEmail: "Imeri ya nyir'inzu",
      paymentAmount: "Igiteranyo cy'Ubwishyu",
      successTitle: "Ubwishyu Bwoherejwe Neza!",
      successMessage:
        "Ubwishyu bwawe bwaherejwe neza !!. Itsinda ryacu riri kugenzura ubwishyu bwawe ,uraza kumenyeshwa mu gihe gito. Sura Dashboard yawe.",
      ...
      close: "Funga",
      cancel: "Hagarika",
      loading: "Amazu akodeshwa...",
      description: "Ibisobanuro",
      hostInfo: "Amakuru ya nyir'inzu",
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setTimeout(() => {
          ...
          // Refresh the entire page after successful login
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setTimeout(() => {
          ...
          // Refresh the entire page after successful registration
          window.location.reload();
        }, 800);
      } else {
        setSuccess(false);
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-6">
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto px-4 leading-relaxed">
                {language === "rw"
                  ? "GUKORA URUBUGA ABANYESHURI BA KAMINUZA BAZAJYA BAJYAHO BAKABONA AMAZU YO GUKODESHA KUBURYO BUBOREHEYE"
                  : language === "fr"
                    ...
                    <div className="border-t border-gray-200 pt-3 sm:pt-4 mt-3 sm:mt-4">
                      ...
                      <div className="bg-gray-50 rounded-lg p-3">
                        <p className="text-xs text-gray-500 mt-1">
                          ...
                          {selectedHouse.host.responseTime || " 1-6 hrs"}
                        </p>
                      </div>
                    </div>
